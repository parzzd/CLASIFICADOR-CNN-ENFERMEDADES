...
def predict_image(image_path):
    ...
    img = cv2.resize(img, (300, 300))  # Ajusta el tamaño según lo entrenado

    # Normaliza la imagen si es necesario
    img = img / 255.0  # Normaliza los valores de píxeles al rango [0, 1]
...
if __name__ == '__main__':
    ...
    model = tf.keras.models.load_model('app/modelo.keras')
